...
from ott2.problems.quadratic import quadratic_costs
from ott2.types import Transport

if TYPE_CHECKING:
  from ott2.solvers.linear import sinkhorn_lr
  ...
  def to_low_rank(
    ...
    if self.is_fused:
      if isinstance(
        ...
        geom_xy = geom_xy.to_LRCGeometry(rank=r3, tol=t3, rng=rng3)
